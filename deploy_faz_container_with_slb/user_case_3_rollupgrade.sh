...
get_devicelist_from_faz | tee >> $filename

echo "start upgrade to version 7.2.2"

kubectl set image deployment/fortianalyzer-deployment fortianalyzer=fortinet/fortianalyzer:7.2.2 | tee >> $filename
